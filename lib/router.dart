...
final class AppRouter {
  static MaterialPageRoute onGenerateRoute(final RouteSettings settings) {
    log('onGenerateRoute called with ${settings.name}', name: 'Application');
    ...
    return CustomPageRoute(builder: (context) {
      ...
      } else if (settings.name == ImmutableProfilePage.routeName) {
        return ImmutableProfilePage(user: settings.arguments as UserEntity);
